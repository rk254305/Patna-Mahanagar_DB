...
let ASSEMBLY_DEMOGRAPHICS = {
  "181_digha": {
    ...
    wards: [
      { wardNo: 1, name: "Ward 1", booths: 33, area: "Digha Ghat / Rajiv Nagar", voters: 31992 },
      { wardNo: 2, name: "Ward 2", booths: 25, area: "Ashiyana Nagar / Khajpura", voters: 23438 },
      { wardNo: 3, name: "Ward 3", booths: 16, area: "Murlichak / Khalilpura / Sabzapur", voters: 14470 },
      { wardNo: 4, name: "Ward 4", booths: 26, area: "Shekhpura / Raja Bazar / Khajpura", voters: 22939 },
      ...
      { wardNo: 8, name: "Ward 8", booths: 25, area: "Shastri Nagar / Punai Chak / Patel Nagar", voters: 21420 },
      { wardNo: 9, name: "Ward 9", booths: 9, area: "Beli Road / Harding Road / Kaushal Nagar", voters: 7026 },
      { wardNo: 10, name: "Ward 10", booths: 28, area: "Anisabad / Phulwari Border", voters: 21151 },
      { wardNo: 12, name: "Ward 12", booths: 35, area: "Chitkhohra / Anisabad / Shivpuri", voters: 30326 },
      { wardNo: 13, name: "Ward 13", booths: 35, area: "Saristabad / Gardanibagh / Sadhnapuri", voters: 32888 },
      { wardNo: 14, name: "Ward 14", booths: 33, area: "Saristabad / Mahavir Cancer Sansthan Area", voters: 31178 },
      { wardNo: 15, name: "Ward 15", booths: 8, area: "Chitkhohra / Anisabad / Shivpuri", voters: 7019 },
      { wardNo: 16, name: "Ward 16", booths: 3, area: "Jakkanpur / Jhunjhun Mahal", voters: 2669 },
      { wardNo: 19, name: "Ward 19", booths: 2, area: "Jakkanpur / Mithapur Border", voters: 1746 },
      { wardNo: 20, name: "Ward 20", booths: 17, area: "Punai Chak / Rajvanshi Nagar", voters: 21543 },
      { wardNo: 21, name: "Ward 21", booths: 22, area: "A.N College / Boring Road / Adalat Ganj", voters: 17278 },
      { wardNo: 22, name: "Ward 22", booths: 22, area: "Patliputra Colony / Gosaintola", voters: 23497 },
    ...
    otherAreas: "23 Wards and Units covering Patliputra, Digha, Rajiv Nagar and Danapur Border",
  ...
  "182_bankipur": {
    ...
    wards: [
      { wardNo: 15, name: "Ward 15", booths: 14, area: "Gandhi Maidan / Exhibition Road / Frazer Road", voters: 11922 },
      { wardNo: 16, name: "Ward 16", booths: 12, area: "Jakkanpur / Jhunjhun Mahal", voters: 10670 },
      { wardNo: 17, name: "Ward 17", booths: 22, area: "Boring Canal Road / Sri Krishna Puri (SK Puri)", voters: 19219 },
      { wardNo: 18, name: "Ward 18", booths: 23, area: "Kidwaipuri / Buddha Colony / Mandiri", voters: 21062 },
      { wardNo: 19, name: "Ward 19", booths: 23, area: "Kadamkuan / Sahityakar Colony / Park Road", voters: 19429 },
      { wardNo: 21, name: "Ward 21", booths: 15, area: "A.N College / Boring Road / Adalat Ganj", voters: 13035 },
      { wardNo: 22, name: "Ward 22", booths: 19, area: "Naya Tola / Machhua Toli / Bari Path / Bakarganj", voters: 16107 },
      { wardNo: 23, name: "Ward 23", booths: 19, area: "Kankarbagh North / Doctors Colony / Ashok Nagar", voters: 16933 },
      { wardNo: 24, name: "Ward 24", booths: 17, area: "Kankarbagh Central / Lohia Nagar", voters: 15357 },
      { wardNo: 25, name: "Ward 25", booths: 14, area: "Kadamkuan East / Rajendra Nagar North", voters: 12886 },
      { wardNo: 26, name: "Ward 26", booths: 19, area: "Pirbahore / Patna Market / Ashok Rajpath / Sabzibagh", voters: 16590 },
      { wardNo: 27, name: "Ward 27", booths: 23, area: "RMS Colony / Malahi Pakri / Chitragupt Nagar", voters: 20754 },
      { wardNo: 28, name: "Ward 28", booths: 24, area: "Rajendra Nagar South / Dinkar Golambar / Saidpur", voters: 21429 },
      { wardNo: 29, name: "Ward 29", booths: 26, area: "Bahadurpur / Nand Lal Chhapra / Bazar Samiti West", voters: 23404 },
      { wardNo: 30, name: "Ward 30", booths: 26, area: "Bahadurpur / Sandalpur West / Kumhrar Border", voters: 24659 },
      { wardNo: 31, name: "Ward 31", booths: 2, area: "Chiraiyatand / Postal Park", voters: 1856 },
      { wardNo: 35, name: "Ward 35", booths: 12, area: "Chiraiyatand / Postal Park / Munna Chak", voters: 10630 },
      { wardNo: 36, name: "Ward 36", booths: 32, area: "Purbi Lohanipur / Kadamkuan South / Congress Maidan", voters: 29913 },
      { wardNo: 37, name: "Ward 37", booths: 13, area: "Lohanipur East / Railway Colony / Kadamkuan", voters: 11380 },
      { wardNo: 38, name: "Ward 38", booths: 23, area: "Kadamkuan / Churi Market / Shiva Mandir Gali", voters: 20802 },
      { wardNo: 39, name: "Ward 39", booths: 14, area: "New Jakkanpur / Dariyapur / Machhua Toli South", voters: 13485 },
      { wardNo: 40, name: "Ward 40", booths: 17, area: "Govind Mitra Road (GM Road) / BM Das Road / Pirbahore", voters: 15128 },
      { wardNo: 41, name: "Ward 41", booths: 7, area: "Lohanipur Main / Kadamkuan Main Road", voters: 6093 },
      { wardNo: 42, name: "Ward 42", booths: 6, area: "Rajendra Nagar / Arya Kumar Road / Stadium", voters: 5506 }
    ],
    otherAreas: "24 Wards covering Central Commercial and Administrative Hub of Patna",
  ...
  "183_kumhrar": {
    ...
    wards: [
      { wardNo: 2, name: "Ward 2", booths: 1, area: "Ashiyana Nagar / Khajpura Border", voters: 1100 },
      { wardNo: 30, name: "Ward 30", booths: 4, area: "Bahadurpur / Sandalpur (Kumhrar portion)", voters: 4274 },
      { wardNo: 31, name: "Ward 31", booths: 25, area: "Chiraiyatand / Postal Park", voters: 26607 },
      { wardNo: 32, name: "Ward 32", booths: 9, area: "Kankarbagh / Doctors Colony / Kumhrar West", voters: 8500 },
      { wardNo: 33, name: "Ward 33", booths: 23, area: "Kankarbagh / Postal Park / RMS Colony", voters: 22971 },
      { wardNo: 34, name: "Ward 34", booths: 22, area: "Kankarbagh / Lohia Nagar", voters: 23923 },
      { wardNo: 35, name: "Ward 35", booths: 9, area: "Chiraiyatand / Postal Park / Munna Chak", voters: 9731 },
      { wardNo: 36, name: "Ward 36", booths: 1, area: "Lohanipur East Border", voters: 1022 },
      { wardNo: 41, name: "Ward 41", booths: 21, area: "Lohanipur Main / Rajendra Nagar Border", voters: 19886 },
      { wardNo: 42, name: "Ward 42", booths: 22, area: "Rajendra Nagar North / Arya Kumar Road", voters: 21690 },
      { wardNo: 43, name: "Ward 43", booths: 32, area: "Kadamkuan / Rajendra Nagar Central", voters: 31273 },
      { wardNo: 44, name: "Ward 44", booths: 33, area: "Kankarbagh / Hanuman Nagar / Lohia Nagar / Bahadurpur", voters: 34036 },
      { wardNo: 45, name: "Ward 45", booths: 38, area: "RMS Colony / Malahi Pakri / Chitragupt Nagar", voters: 38067 },
      { wardNo: 46, name: "Ward 46", booths: 30, area: "Bahadurpur / Nand Lal Chhapra", voters: 30473 },
      ...
      { wardNo: 49, name: "Ward 49", booths: 24, area: "Ranighat / Patna Law College / Saidpur", voters: 23804 },
      { wardNo: 50, name: "Ward 50", booths: 36, area: "Ranighat / Mahendru / Muhammadpur / Sandalpur", voters: 38214 },
      { wardNo: 51, name: "Ward 51", booths: 20, area: "Chaudhary Tola / Khajoor Banna / Tripoliya / Mahendru", voters: 22124 },
      { wardNo: 52, name: "Ward 52", booths: 1, area: "Tripoliya / Mahendru Border", voters: 1178 },
      { wardNo: 55, name: "Ward 55", booths: 29, area: "Bahadurpur Housing Colony / Kumhrar / Bhootnath Road", voters: 29804 },
      { wardNo: 60, name: "Ward 60", booths: 1, area: "Kumhrar / Sandalpur Border", voters: 1013 }
    ],
    otherAreas: "22 Wards and Units covering Kankarbagh, Kumhrar, Rajendra Nagar and University Area",
  ...
  "184_patna_sahib": {
    ...
    wards: [
      { wardNo: 52, name: "Ward 52", booths: 28, area: "Tripoliya / Gai Ghat / Alamganj / Gulzarbagh", voters: 27371 },
      { wardNo: 53, name: "Ward 53", booths: 16, area: "Gai Ghat / Shershah Road / Babu Ganj", voters: 15343 },
      { wardNo: 54, name: "Ward 54", booths: 31, area: "Mirdaha Toli / Alabakshpur / Shershah Road", voters: 28536 },
      { wardNo: 56, name: "Ward 56", booths: 23, area: "Maharajganj / Chhoti & Badi Pahari / Jakariyapur", voters: 21157 },
      { wardNo: 57, name: "Ward 57", booths: 15, area: "Meena Bazar / Sadikpur / Tulsimandi / Gulzarbagh", voters: 14652 },
      { wardNo: 58, name: "Ward 58", booths: 28, area: "Mathramma / Chailital / Mahavirghat / Gulzarbagh", voters: 26620 },
      { wardNo: 59, name: "Ward 59", booths: 28, area: "Gujri / Khajekala / Gurhatta / Naujarkatra", voters: 27225 },
      { wardNo: 60, name: "Ward 60", booths: 29, area: "Gujri / Khajekala / Moghalpura / Padri ki Haweli", voters: 26678 },
      ...
      { wardNo: 63, name: "Ward 63", booths: 10, area: "Moghalpura / Noon ka Chauraha / Chowk Shikarpur / Dundi Bazar", voters: 9714 },
      { wardNo: 64, name: "Ward 64", booths: 15, area: "Mangal Talab / Noon ka Chauraha", voters: 14983 },
      { wardNo: 65, name: "Ward 65", booths: 17, area: "Padri ki Haweli / Maharajghat / Tedhighat / Sadar Gali", voters: 16179 },
      { wardNo: 66, name: "Ward 66", booths: 16, area: "Bade ki Gali / Mangal Talab / Chowk Shikarpur", voters: 14812 },
      { wardNo: 67, name: "Ward 67", booths: 25, area: "Chhipi Tola / Nehru Tola / Kila Road / Kalmasikoh", voters: 22956 },
      { wardNo: 68, name: "Ward 68", booths: 13, area: "Chainpura / Dhavalpura / Beldari Tola / Nakhas Mangal Akhada", voters: 11923 },
      { wardNo: 69, name: "Ward 69", booths: 11, area: "Dalhatta / Mashoorganj / Nakhas Mangal Akhada", voters: 11458 },
      { wardNo: 70, name: "Ward 70", booths: 24, area: "Nand Gola / Pirdamariya / Noorganj / Dahuchak Nagla / Shimli", voters: 22397 },
      { wardNo: 71, name: "Ward 71", booths: 8, area: "Chhutkiya Bazar / Noorganj / Malsalami", voters: 8091 },
      { wardNo: 72, name: "Ward 72", booths: 19, area: "Katra Bazar / Rikab Ganj / Nawab Ganj / Sharifa Ganj / Marufganj", voters: 21377 }
    ],
    otherAreas: "20 Wards covering Historic Patna City, Wholesale Mandis and Heritage Ghats",
...
const DOM = {
  ...
  drawerNavMap: document.getElementById('drawerNavMap'),
...
function setupEventListeners() {
  ...
  if (DOM.pillMapView) DOM.pillMapView.addEventListener('click', () => { window.location.href = 'maps.html'; });
  ...
  if (DOM.drawerNavMap) {
    DOM.drawerNavMap.addEventListener('click', () => {
